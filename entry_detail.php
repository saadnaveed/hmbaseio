...
// 				}
				...
				// 	global $wpdb;
				//
				// 	$tierForUpgrade = $lead['5'];
				// 	$currentPlan = $lead['3'];
				// 	$cs_requested = $lead['17.1'];
				// 	$cs_agent_name = $lead['16'];
				// 	$category = $lead['13'];
				// 	$subcategory = $lead['14'];
				// 	$adminLink = $lead['2'];
				// 	$existing_feature_name = $lead['9'];
				// 	$new_feature_name = $lead['12'];
				// 	$new_feature_description = $lead['18'];
				// 	$merchant_reason = $lead['11'];
				// 	$additional_notes = $lead['15'];
				//
				// 	if ($cs_requested != 'Yes') {
				// 		$cs_requested = 'No';
				// 	}
				//
				// 		$wpdb->update("UPDATE cs_feature_requests SET
				...
				// 			WHERE feature_name = '".$existing_feature_name."' AND `agent_name` = '".$cs_agent_name."'");
				//
				// 			$wpdb->update("UPDATE cs_feature_request_comments SET
				// 				`agent_name` = '".$cs_agent_name."',
				// 				`feature_name` = '".$new_feature_name."',
				// 				`feature_description` = '".$new_feature_description."',
				// 				`merchant_reason` = '".$merchant_reason."',
